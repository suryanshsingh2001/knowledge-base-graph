...
export const cyStylesheet: cytoscape.StylesheetStyle[] = [
  {
    ...
    style: {
      ...
      "border-opacity": 0.85,
      // Label is always empty — text is rendered inside the SVG background-image
      label: "",
      width: 200,
      height: "data(nodeHeight)" as any,
      padding: "0px",
      // SVG overlay: accent header + document icon + bold title + muted note
